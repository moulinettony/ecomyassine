...
const LoginComponent = () => {
  ...
  useEffect(() => {
    ...
    const handleLogin = () => {
        const username = usernameInput.value; // Get the entered username
        const password = passwordInput.value; // Get the entered password
      
        // Check if the entered username and password match the admin credentials
        if (username === 'admin@E-commerce.com' && password === '@admin') {
          setIsLoggedIn(true);
          router.push('/admin');
        } else {
      ...
      // Attach the submit event listener to the login button
  ...
  return (
    <div style={{ backgroundImage: 'url("/images/bg.svg")' }} class="h-screen">
      <Head>
        <style>
          {`
            * {
      ...
      <div id="login-form" class="center" >
        ...
        <div class="face">
            ...
            <svg width="38.161" height="22.03">
                <path d="M2.017 10.987Q-.563 7.513.157 4.754C.877 1.994 2.976.135 6.164.093 16.4-.04 22.293-.022 32.048.093c3.501.042 5.48 2.081 6.02 4.661q.54 2.579-2.051 6.233-8.612 10.979-16.664 11.043-8.053.063-17.336-11.043z" fill="#608FF5"></path>
            </svg>
            <div class="glow"></div>
            </div>
            <div class="mouth">
