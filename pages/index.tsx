            ...
            <div className="container relative mx-auto mt-10 w-full max-w-7xl rounded-3xl px-4 sm:mb-10 sm:px-6 md:px-8">
              ...
              <div className="text-center">
                <h2 className="text-2xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                  ...
                  <span className="__className_088d02 text-3xl font-bold sm:text-[2.75rem]">
                    Broken
                  </span>
                  .
                </h2>
              ...
              <div className="flex flex-col place-content-center place-items-center items-center justify-center gap-4 py-10 md:grid md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="flex h-full flex-col items-start justify-start rounded-3xl border border-gray-800/50 bg-gray-950/50 p-7 text-start shadow-2xl shadow-blue-500/10 backdrop-blur-md">
                  ...
                  <h3 className="mb-2 text-xl font-bold text-white">Tired of the Same Old?</h3>
                  <p className="text-gray-400">Take control of your own team and call center delivery for less than 4E per shipment, making work both enjoyable and profitable.</p>
                </div>
                <div className="flex h-full flex-col items-start justify-start rounded-3xl border border-gray-800/50 bg-gray-950/50 p-7 text-start shadow-2xl shadow-blue-500/10 backdrop-blur-md">
                  <div className="mb-8 flex size-16 items-center justify-center rounded-xl bg-gray-900 p-4">
                  ...
                  <h3 className="mb-2 text-xl font-bold text-white">Learn the COD Secrets</h3>
                  <p className="text-gray-400">Dive into what really happens in the COD business model and turn it to your advantage.</p>
                </div>
              </div>
            </div>
            <div className="absolute left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl" aria-hidden="true"><div className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-indigo-500 to-blue-500 opacity-30" style={{ clipPath: 'polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.1% 56.8%, 46.9% 44%, 48.3% 17.4%, 24.7% 53.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)' }}></div></div>
            <div className="absolute left-[max(45rem,calc(50%+8rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl" aria-hidden="true"><div className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-indigo-500 to-blue-500 opacity-30" style={{ clipPath: 'polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.1% 56.8%, 46.9% 44%, 48.3% 17.4%, 24.7% 53.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)' }}></div></div>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-0 flex h-auto w-full flex-col items-center justify-center">
          <div className="relative isolate">
            <div className="container relative mx-auto my-4 w-full max-w-7xl rounded-3xl px-4 sm:my-10 sm:px-6 md:px-8">
              <div className="mb-8 flex justify-center">
                <a href="" className="flex size-auto items-center justify-start bg-none">
                  <img className="size-16 rounded-xl shadow-2xl shadow-blue-500/10 backdrop-blur-md" width={64} height={64} src="images/icon-dark-3x.webp" alt="" />
                </a>
              </div>
              <div className="mb-8 flex justify-center">
                <div className="relative inline-block bg-gradient-to-r from-blue-600 to-indigo-400 bg-clip-text text-lg font-bold uppercase leading-6 text-transparent md:text-2xl">Master Program</div>
              </div>
              <div className="flex w-full flex-col items-center justify-center text-center">
                <h2 className="text-2xl font-bold tracking-tight text-gray-50 sm:text-4xl">Master the Art of Cash on Delivery.</h2>
                <p className="mt-6 max-w-3xl text-base leading-8 text-gray-600">Ready to conquer Cash on Delivery? Our program shows you how to test, scale, and hit +$10k with ease. We've got all the resources you need to succeed.</p>
                <div className="relative mt-10 flex flex-row items-center justify-center gap-2">
                  <a href="" className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform-gpu transition-transform duration-200 hover:scale-105 active:scale-95 border border-blue-500 bg-white font-bold text-blue-500 shadow-2xl shadow-blue-500/50 hover:bg-blue-50 hover:text-blue-600 active:bg-blue-100 h-11 px-8 rounded-full">Let's Get Started</a>
                </div>
              </div>
              <div className="flex flex-col place-content-center place-items-center items-center justify-center gap-4 pt-10 sm:pb-10 md:grid md:grid-cols-2 lg:grid-cols-2">
                <div className="flex h-full flex-col items-start justify-start overflow-hidden rounded-3xl border border-gray-800/50 bg-gray-950/50 p-7 text-start shadow-2xl shadow-blue-500/10 backdrop-blur-md">
                  <h3 className="mb-2 text-xl font-bold text-white">Last Updated Methods and Structures</h3>
                  <p className="text-gray-400">As a member of our EV program, you'll gain access to the latest +35 video updates on Cash on Delivery methods and structures. Stay informed about essential updates and learn the structures needed to establish your business.</p>
                  <div className="-mb-14 mt-8 flex w-full items-center justify-center">
                    <img className="size-full rounded-xl shadow-2xl shadow-blue-500/10 backdrop-blur-md" src="images/image-1.webp" alt="" />
                  </div>
                </div>
                <div className="flex h-full flex-col items-start justify-start overflow-hidden rounded-3xl border border-gray-800/50 bg-gray-950/50 p-7 text-start shadow-2xl shadow-blue-500/10 backdrop-blur-md">
                  <h3 className="mb-2 text-xl font-bold text-white">1v1 Daily Coaching</h3>
                  <p className="text-gray-400">In our EV program, we work closely with your coaches and team to help you establish your COD business model. With daily communication and one-on-one coaching sessions on your slack channel we provide the easiest way to learn by doing.</p>
                  <div className="-mb-14 mt-8 flex w-full items-center justify-center">
                    <img className="size-full rounded-xl shadow-2xl shadow-blue-500/10 backdrop-blur-md" src="images/image-2.webp" alt="" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="w-full py-10 sm:py-24 md:py-32">
        <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-4 sm:px-6 md:px-8 xl:grid-cols-2">
          <div className="relative flex h-auto w-full flex-col items-center justify-center">
            <img className="aspect-square size-full rounded-3xl object-cover" src="images/yassine.jpeg" alt="" />
          </div>
          <div className="flex h-full w-full max-w-2xl flex-col items-start justify-center">
            <div className="mb-8 flex justify-start">
              <div className="relative inline-block bg-gradient-to-r from-blue-600 to-indigo-400 bg-clip-text text-sm font-bold uppercase leading-6 text-transparent">Who's Me?</div>
            </div>
            <div className="text-start">
              <h2 className="text-2xl font-bold tracking-tight text-gray-50 sm:text-4xl">Meet Yassine Fallahi</h2>
                <p className="mt-6 text-base leading-8 text-gray-400">A dedicated 21-year-old entrepreneur from Morocco who started his journey alone, without any handouts. Driven by his passion for e-commerce, he's dedicated himself to sharing his knowledge and helping thousands. Aassim's commitment extends to empowering communities in Morocco and Eastern Europe. His expertise lies in guiding individuals through the ins and outs of the Cash on Delivery (COD) market.</p>
            </div>
          </div>
        </div>
      </section>
